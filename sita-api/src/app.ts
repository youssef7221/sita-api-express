...
import adminProductSizeChartRoutes from "./routes/adminRoutes/adminProductSizeChartRoutes";
...
app.use("/api/products", sizeChartRoutes);
...
app.use(`${ADMIN_BASE_ROUTE}/products`, adminProductSizeChartRoutes);
